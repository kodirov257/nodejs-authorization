...
const serverResponseData = {
    errors: [
        {
            message: 'Field \\"auth_by_facebook\\" of type \\"AuthPayload\\" must have a selection of subfields. Did you mean \\"auth_by_facebook { ... }\\"?',
            locations: [
                {
                    line: 70,
                    column: 3,
            ...
            extensions: {
                ...
                exception: {
                    stacktrace: [
											"GraphQLError: Field \\\"auth_by_facebook\\\" of type \\\"AuthPayload\\\" must have a selection of subfields. Did you mean \\\"auth_by_facebook { ... }\\\"?",
...
test('register calls fetch with no return values provided and returns error', async () => {
    ...
    expect(response.errors[0].message).toContain('Field \\"auth_by_facebook\\" of type \\"AuthPayload\\" must have a selection of subfields. Did you mean \\"auth_by_facebook { ... }\\"?');
