...
const serverResponseData = {
    errors: [
        {
            message: 'Field \"refresh_token\" of type \"RefreshPayload\" must have a selection of subfields. Did you mean \"refresh_token { ... }\"?',
            locations: [
                {
                    line: 52,
                    column: 3,
            ...
            extensions: {
                ...
                exception: {
                    stacktrace: [
                        "GraphQLError: Field \"refresh_token\" of type \"RefreshPayload\" must have a selection of subfields. Did you mean \"refresh_token { ... }\"?",
...
test('register calls fetch with the no return value and returns error', async () => {
    ...
    expect(response.errors[0].extensions.code).toContain('GRAPHQL_VALIDATION_FAILED');
