...
const serverResponseData = {
  errors: [
    {
      message: 'Field \\"signin\\" argument \\"login\\" of type \\"String!\\" is required, but it was not provided.',
      locations: [
        {
          line: 17,
          column: 3,
      ...
      extensions: {
        ...
        exception: {
          stacktrace: [
            "GraphQLError: Field \\\"signin\\\" argument \\\"login\\\" of type \\\"String!\\\" is required, but it was not provided.",
...
test('register calls fetch with the wrong arguments and returns error', async () => {
  ...
  expect(response.errors[0].message).toContain('Field \\"signin\\" argument \\"login\\" of type \\"String!\\" is required, but it was not provided.');
