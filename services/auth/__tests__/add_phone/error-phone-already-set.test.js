    ...
    errors: [
        {
            ...
            extensions: {
                ...
                exception: {
                    stacktrace: [
						"Error: Phone number is already set.",
						"    at sendAddPhoneToken (/app/services/user/add_phone.js:39:9)",
...
test('register calls fetch with already set values and returns error', async () => {
    ...
    expect(response.errors[0].message).toContain('Phone number is already set.');
